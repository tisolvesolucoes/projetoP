...
function mainController($scope, $http, $rootScope, $location) {
        ...
        try {
            client.on('header', function (message) {
                if (message === '0') {
                    ...
                    var textInput = void 0, arrayOptionInput = void 0, distanceInput = void 0, pag = void 0;
                    $('#submitSearch').click(function () {
                        var resultInputSearch = $('#boxSearch').val();
                        var valInputActive = $('.subOptionsSearch li.active a');
                        var selectDistance = $('#distancia option:selected').val();
                        var arryInputActive = [];
                        var parameterSearch = window.location.pathname;
    ...
    client.on('verificaChat', function (message) {
        if (message[0][0].Socket_From == $.jStorage.get("key")) {
            var contentChat = $('#container_' + message[0][0].UsernameTo);
...
function openChat(user_to, user_from) {
    ...
    var recebeChat = function (array_to, array_from) {
