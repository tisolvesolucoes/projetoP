...
define(['app'], function (app) {
    app.controller('loginCtrl', function ($scope, $rootScope, $location) {
        ...
        $rootScope.questionaSessao('login');
        ...
        $("#frmCadastrar").validate({
            ...
            submitHandler: function (form) {
                ...
                var frm_email_cad = document.forms["frmCadastrar"]["email_cad"].value;
                var frm_confirmacaoEmail = document.forms["frmCadastrar"]["confirmacaoEmail"].value;
                var frm_senha_cad = document.forms["frmCadastrar"]["senha_cad"].value;
                var frm_dia = document.forms["frmCadastrar"]["dia"].value;
                var frm_mes = document.forms["frmCadastrar"]["mes"].value;
                var frm_ano = document.forms["frmCadastrar"]["ano"].value;
                var frm_sexo = document.forms["frmCadastrar"]["sexo"].value;
                var frm_data = frm_dia + '/' + frm_mes + '/' + frm_ano;
