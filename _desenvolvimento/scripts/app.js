    ...
    var app = angular.module("webapp", ['ngRoute', 'routeStyles'])
        ...
        .config(['$routeProvider', '$locationProvider', function ($routeProvider, $locationProvider) {
            ...
            $routeProvider
                ...
                .when("/busca/:itemId", angularAMD.route({
                templateUrl: 'views/busca/index.html',
                controller: 'buscaCtrl',
                controllerUrl: '../scripts/views/busca/busca',
                css: ['content/css/views/busca.css', 'content/css/main.css']
            }))
                .otherwise({
                redirectTo: '/home'
            });
