...
-- Copiando dados para a tabela app_pertube.anuncios: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela app_pertube.auth: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela app_pertube.chat: ~33 rows (aproximadamente)
/*!40000 ALTER TABLE `chat` DISABLE KEYS */;
INSERT INTO `chat` (`ID`, `IDUsuario_TO`, `IDUsuario_FROM`, `DTMensagem`, `Mensagem`) VALUES
	(261, 68, 69, '2017-06-23 19:57:31', '5050'),
	(262, 69, 68, '2017-06-23 19:57:44', '02'),
	(263, 68, 69, '2017-06-23 19:59:44', 's'),
	(264, 69, 68, '2017-06-23 19:59:53', 'dddd'),
	(265, 68, 69, '2017-06-23 20:00:57', 'd'),
	(266, 68, 69, '2017-06-23 20:02:13', 's'),
	(267, 68, 69, '2017-06-23 20:02:49', 'sd'),
	(268, 69, 68, '2017-06-23 20:03:34', 'bg'),
	(269, 69, 68, '2017-06-23 20:04:03', 's'),
	(270, 69, 68, '2017-06-23 20:04:28', 'ytyty'),
	(271, 69, 68, '2017-06-23 20:06:04', 'dssdsdsds'),
	(272, 68, 69, '2017-06-23 20:06:09', 'sasasasasa'),
	(273, 68, 69, '2017-06-23 20:06:48', 'dsdsdsdsd\n'),
	(274, 69, 68, '2017-06-23 20:06:52', 'asasasasa\n'),
	(275, 68, 69, '2017-06-23 20:07:51', 'dsdsds'),
	(276, 69, 68, '2017-06-23 20:07:57', 'dsdsdsgbn'),
	(277, 69, 68, '2017-06-23 20:08:01', '6546\n'),
	(278, 69, 68, '2017-06-23 20:08:37', 'gfgfgf'),
	(279, 68, 69, '2017-06-23 20:08:42', 'asdadadasdad'),
	(280, 68, 69, '2017-06-23 20:08:50', 'deu certo\n'),
	(281, 68, 69, '2017-06-23 20:19:06', 'dsadasdad'),
	(282, 68, 69, '2017-06-23 20:34:33', 'sdsdsdsdsdsdds'),
	(283, 69, 68, '2017-06-23 20:34:36', 'dsdsdsd'),
	(284, 68, 69, '2017-06-23 20:34:47', 'dsddsdsdsds'),
	(285, 68, 69, '2017-06-23 20:36:14', '3213213213213213213213213213'),
	(286, 69, 68, '2017-06-23 20:36:24', 'teste'),
	(287, 68, 69, '2017-06-23 20:37:47', 'dsdsdsdsd'),
	(288, 68, 69, '2017-06-23 20:39:27', 'fdfdfdfdf'),
	(289, 68, 69, '2017-06-23 20:40:42', 'sdsdsds'),
	(290, 68, 69, '2017-06-23 20:48:35', 'zxzxzxzxz'),
	(291, 68, 69, '2017-06-23 20:49:16', '6546546'),
	(292, 68, 69, '2017-06-23 20:50:49', '\n5'),
	(293, 68, 69, '2017-06-23 20:59:46', 'sd');
...
-- Copiando dados para a tabela app_pertube.emails: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `emails` DISABLE KEYS */;
INSERT INTO `emails` (`ID`, `IDUsuarios`, `Emails`, `Status`) VALUES
	(183, 68, 'teste2@teste.com', 0),
	(186, 68, 'fabio.nsousa1@gmail.com', 1),
	(187, 69, 'teste@teste.com', 1);
...
-- Copiando dados para a tabela app_pertube.enderecos: ~2 rows (aproximadamente)
...
INSERT INTO `enderecos` (`IDEndereco`, `CEP`, `Logradouro`, `Estado`, `Cidade`, `Regiao`, `Bairro`, `Numero`, `Complemento`, `Latitude`, `Longitude`) VALUES
	...
	(93, '02202-000', 'Rua Aldeia Vinte de Setembro', 'SP', 'São Paulo', '', 'Vila Ede', '553', '', '-23.494443', '-46.5946693');
...
-- Copiando dados para a tabela app_pertube.info_usuarios: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela app_pertube.midia_social: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela app_pertube.musicas: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela app_pertube.sobre_usuarios: ~1 rows (aproximadamente)
...
INSERT INTO `telefones` (`ID`, `IDUsuarios`, `Telefones`, `Status`) VALUES
	(47, 68, '(11) 32132-1321', 1),
	(48, 69, '(11) 98989-8989', 1);
...
-- Copiando dados para a tabela app_pertube.usuarios: ~2 rows (aproximadamente)
...
INSERT INTO `usuarios` (`ID`, `IDEndereco`, `Nome`, `Sobrenome`, `Username`, `Senha`, `DTNascimento`, `SexoUser`, `DTCriacao`, `DTAtualizacao`, `Imagem`, `TipoAcesso`, `Status`) VALUES
	(68, 92, 'fabio', 'sousa', '65321656473290', '753951', '1978-03-05', 1, '2017-05-27 17:54:32', '2017-05-27 17:54:32', 'content/images/6598807329614/thumbs/KAR7enw8NWetF5gZ89UyHsUT263CwcTu.jpg', 1, 1),
	(69, 93, 'kelly', 'rodrigues', '6532165866362', '753951', '2015-01-02', 2, '2017-06-20 16:49:57', '2017-06-20 16:49:57', 'content/images/noimage.jpg', 1, 1);
...
-- Copiando dados para a tabela app_pertube.videos: ~1 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `visitantes` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `IDUsuarioVisitante` int(11) NOT NULL,
  `IDUsuarioVisitado` int(11) NOT NULL,
  `DataVisita` datetime NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `FK_visitantes_usuarios` (`IDUsuarioVisitante`),
  KEY `FK_visitantes_usuarios_2` (`IDUsuarioVisitado`),
  CONSTRAINT `FK_visitantes_usuarios` FOREIGN KEY (`IDUsuarioVisitante`) REFERENCES `usuarios` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_visitantes_usuarios_2` FOREIGN KEY (`IDUsuarioVisitado`) REFERENCES `usuarios` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Copiando dados para a tabela app_pertube.visitantes: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `visitantes` DISABLE KEYS */;
INSERT INTO `visitantes` (`ID`, `IDUsuarioVisitante`, `IDUsuarioVisitado`, `DataVisita`) VALUES
	(1, 68, 69, '2017-06-21 14:48:28'),
	(2, 69, 68, '2017-06-21 15:11:06');
...
-- Copiando estrutura para procedure app_pertube.BUSCA
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `BUSCA`(IN `texto` VARBINARY(250), IN `array` VARCHAR(250), IN `distancia` INT, IN `pagina` INT, IN `userLogado` INT
)
BEGIN
	SELECT
		...
		b.TipoAnuncio, ROUND((
	   	3959 * acos (
	      	...
	      	* cos( radians( c.Longitude ) - radians(65.3234) )
	      	+ sin ( radians(78.3232) )
	...
	FROM
		usuarios a
	left JOIN anuncios b ON
		b.IDUsuarios = a.ID
	left JOIN enderecos c ON
		c.IDEndereco = a.IDEndereco
	WHERE 
		a.ID <> userLogado
	OR
		a.Nome LIKE CONCAT('%', texto , '%')
	OR
		b.TipoAnuncio LIKE CONCAT('%', array , '%')
	HAVING 
		distance < distancia
	ORDER BY 
		distance
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `CHAT`(IN `chat_to` CHAR(50), IN `chat_from` CHAR(50)
...
from (
	...
	(SELECT
		...
		a.DTMensagem,
		b.Nome AS Nome_to,
		(SELECT Nome FROM usuarios WHERE ID = chat_from) AS Nome_from,
		b.Imagem,
		(SELECT Username FROM usuarios WHERE ID = chat_from) AS UsernameTo,
		b.Username AS UsernameFrom		
	FROM 
		chat a
	LEFT JOIN usuarios b on
...
-- Copiando estrutura para procedure app_pertube.INSERTCHAT
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `INSERTCHAT`(IN `MSN` VARCHAR(250)

, IN `IDTo` INT, IN `IDFrom` INT

)
BEGIN
	INSERT INTO chat (IDUsuario_TO, IDUsuario_FROM, DTMensagem, Mensagem) VALUES (IDTo, IDFrom, now(), MSN);
...
from (
	(SELECT
		...
		a.DTMensagem,
		b.Nome AS Nome_to,
		(SELECT Nome FROM usuarios WHERE ID = IDTo) AS Nome_from,
		b.Imagem,
		(SELECT Username FROM usuarios WHERE ID = IDTo) AS UsernameTo,
		b.Username AS UsernameFrom,
		(select IDSocket from auth where IDUsuarios = IDTo) as Socket_To,
		(select IDSocket from auth where IDUsuarios = IDFrom) as Socket_From	
	FROM 
		chat a
	LEFT JOIN usuarios b on
		b.ID = a.IDUsuario_TO
	WHERE 
		a.IDUsuario_TO = IDFrom
	AND
		a.IDUsuario_FROM = IDTo)
	union all
	(SELECT
		a.ID,
		a.Mensagem,
		a.DTMensagem,
		b.Nome AS Nome_to,
		(SELECT Nome FROM usuarios WHERE ID = IDFrom) AS Nome_from,
		b.Imagem,
		(SELECT Username FROM usuarios WHERE ID = IDFrom) AS UsernameTo,
		b.Username AS UsernameFrom,
		(select IDSocket from auth where IDUsuarios = IDTo) as Socket_To,
		(select IDSocket from auth where IDUsuarios = IDFrom) as Socket_From	
	FROM 
...
order by g.ID DESC LIMIT 1;
	...
	/*select *
		from (	
			(SELECT
				b.ID,
				b.IDUsuario_TO AS TOs,
				b.IDUsuario_FROM,
				b.DTMensagem,
				b.Mensagem,
				(select Nome from usuarios where ID = IDTo) as Nome_to,
				(select Username from usuarios where ID = IDFrom) as Username_FROM,
				(select Username from usuarios where ID = IDTo) as Username_TO,
				(select IDSocket from auth where IDUsuarios = IDFrom) as Socket_TO
			FROM 
				chat b  
			WHERE 
				b.IDUsuario_TO = IDTo
			AND
				b.IDUsuario_FROM = IDFrom)		
			
			union 
			
			(SELECT
				b.ID,
				b.IDUsuario_TO AS FROMs,
				b.IDUsuario_FROM,
				b.DTMensagem,
				b.Mensagem,
				(select Nome from usuarios where ID = IDFrom) as NomeFroms,
				(select Username from usuarios where ID = IDTo) as Username_TO,
				(select Username from usuarios where ID = IDFrom) as Username_FROM,
				(select IDSocket from auth where IDUsuarios = IDTo) as Socket_FROM
			FROM 
				chat b  
			WHERE 
				b.IDUsuario_TO = IDFrom
			AND
				b.IDUsuario_FROM = IDTo)
		) g
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `SESSION`(
	IN `tokenUser` VARCHAR(50)
...
BEGIN
	...
	FROM
		visitantes a
	LEFT JOIN usuarios b ON
		b.ID = a.IDUsuarioVisitante
	LEFT JOIN auth c ON
		c.IDUsuarios = a.IDUsuarioVisitado
	WHERE
		c.IDSocket = tokenUser;					
END//
DELIMITER ;
...
-- Copiando estrutura para procedure app_pertube.VISITANTE
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `VISITANTE`(
	IN `userLogado` VARCHAR(250),
	IN `userVisitado` VARCHAR(250)
...
BEGIN
	...
	DECLARE IDVisitado  INT;
	
	SET IDVisitante = (SELECT IDUsuarios FROM auth WHERE IDSocket   = userLogado);
	SET IDVisitado  = (SELECT IDUsuarios FROM auth WHERE IDUsername = userVisitado);
	
	IF IDVisitante = IDVisitado 
		THEN 
		SELECT '0';
 	ELSEIF EXISTS (SELECT 1 FROM visitantes a WHERE a.IDUsuarioVisitante = IDVisitante AND a.IDUsuarioVisitado = IDVisitado)
 		THEN
		SELECT '1';
 	ELSE 	
 		INSERT INTO visitantes (IDUsuarioVisitante, IDUsuarioVisitado, DataVisita) VALUES (IDVisitante, IDVisitado, NOW());
 		SELECT 'OK';
 	END IF; 
END//
DELIMITER ;
